...
export class AccountTokenApi extends BaseLoopBackApi {
  ...
  public findByIdAccessTokens(id: any, fk: any, customHeaders?: Function): Observable<any> {
    ...
    "/AccountTokens/:id/accessTokens/:fk";
  ...
  /**
   * Queries accessTokens of AccountToken.
   *
   * @param {any} id AccountToken id
   *
   * @param {object} filter 
  ...
  /**
   * Counts accessTokens of AccountToken.
   *
   * @param {any} id AccountToken id
   *
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AccountTokens/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * @ngdoc method
   * @name sdk.AccountToken#getCurrent
   * @methodOf sdk.AccountToken
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/AccountTokens" + "/:id";
   ...
   * call to {@link sdk.AccountToken#login} or
   * {@link sdk.AccountToken#getCurrent}. Return null when there
   ...
   * call to {@link sdk.AccountToken#login}
   *
  ...
  /**
   * @name sdk.AccountToken#isAuthenticated
   *
  ...
  /**
   * @name sdk.AccountToken#getCurrentId
   *
